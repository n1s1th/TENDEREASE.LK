-- V18: Create addendum_version table and rename version column if not done yet
...
BEGIN
    IF EXISTS (
        ...
        ALTER TABLE tender_amendment RENAME COLUMN version TO current_version_number;
    END IF;
END $$;

CREATE TABLE IF NOT EXISTS addendum_version (
...
CREATE INDEX IF NOT EXISTS idx_addendum_version_addendum_id ON addendum_version(addendum_id);
