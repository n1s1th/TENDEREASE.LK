...
import type { TenderTab } from "@/lib/types/officer-dashboard.types";
...
const tabs: TabDef[] = [
  { key: "pending", label: "Pending", href: "/officer-dashboard/tenders/pending" },
  { key: "approved", label: "Approved", href: "/officer-dashboard/tenders/approved" },
...
export default function TabBar({ badgeCounts }: TabBarProps) {
  ...
  const searchQuery = useOfficerDashboardStore((s) => s.searchQuery);
  const setSearchQuery = useOfficerDashboardStore((s) => s.setSearchQuery);
