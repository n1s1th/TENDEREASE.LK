  ...
  return (
    <div className="bg-white rounded-3xl border border-gray-100 p-4 shadow-sm flex flex-col h-full">
      <div className="flex justify-between items-center mb-3">
        <h3 className="text-[13px] font-black text-gray-400 uppercase tracking-widest">Opening Schedule</h3>
        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">AUTO-SYNCED</span>
      </div>
      
      <div className="flex flex-1 items-stretch">
        <div className="flex-1 flex flex-col items-center justify-center">
          <span className="text-[11px] font-black text-gray-400 uppercase tracking-widest mb-1.5">SCHEDULED</span>
          <span className="text-2xl font-black text-gray-900 tracking-tighter">{timeStr}</span>
          <span className="text-[12px] font-bold text-gray-500 mt-0.5">{dateStr}</span>
        </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center pl-3">
          ...
          <span className="text-2xl font-black text-[#953002] tracking-tighter">{curTimeStr}</span>
          <span className="text-[12px] font-bold text-gray-500 mt-0.5">{curDateStr}</span>
        </div>
      </div>
