...
import { User, Search, X, Menu, ChevronRight } from "lucide-react";
...
export default function AppHeader() {
  ...
  return (
    <>
      {/* ─── Main Header ──────────────────────────────────────────────────── */}
      <header className="fixed top-0 inset-x-0 z-50 bg-white/80 backdrop-blur-lg border-b border-white/20 shadow-[0_2px_24px_rgba(0,0,0,0.06)]">
        {/* ── Top accent bar ── */}
