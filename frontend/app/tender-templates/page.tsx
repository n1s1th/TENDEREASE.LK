          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {templates.map((template) => (
                ...
                >
                  {/* Status Ribbon */}
                  <div className={`absolute top-0 right-0 px-4 py-1.5 rounded-bl-xl text-[10px] font-bold tracking-wider uppercase ${template.status === 'PUBLISHED' ? 'bg-emerald-100 text-emerald-800 border-b border-l border-emerald-200' :
