...
const mockData = [
  { id: 'T-1004', title: 'Medical Supplies Procurement', category: 'Goods', type: 'RFQ', date: '2026-02-20', reason: 'Insufficient technical justification' },
  { id: 'T-1005', title: 'Road Rehabilitation Project', category: 'Works', type: 'ICB', date: '2026-02-18', reason: 'Bid exceeded budget limits' },
];
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-surface-2 border-b-2 border-border">
              ...
              <TableHead className="text-[11px] font-bold uppercase tracking-wider text-text-muted">Rejected Date</TableHead>
              <TableHead className="text-[11px] font-bold uppercase tracking-wider text-text-muted">Reason</TableHead>
                ...
                <TableRow key={tender.id} className="hover:bg-[#faf8f6]">
                  ...
                  <TableCell>
                    <div className="max-w-[300px]">
                      <Badge className="bg-danger-bg text-danger px-2.5 py-1 font-semibold text-[12px] rounded-full mb-1">
                        Rejected
                      </Badge>
                      <p className="text-[12px] text-text-muted mt-1">{tender.reason}</p>
                    </div>
                  </TableCell>
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="bg-surface border-border w-[180px]">
                        ...
                        <DropdownMenuItem className="text-text-primary focus:bg-bg focus:text-text-primary">Edit Recommendation</DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
                  </TableCell>
                </TableRow>
