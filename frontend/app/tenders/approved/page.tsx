...
const mockData = [
  { id: 'T-1001', title: 'Supply of Office Equipment', category: 'Goods', type: 'NCB', date: '2026-01-15', score: '92%', status: 'Award Processed' },
  { id: 'T-1002', title: 'Construction of Community Hall', category: 'Works', type: 'NCB', date: '2026-01-10', score: '88%', status: 'Approved - Awaiting Award Processing' },
  { id: 'T-1003', title: 'IT Infrastructure Upgrade', category: 'IT & Technology', type: 'ICB', date: '2026-01-08', score: '95%', status: 'Award Processed' },
];
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-surface-2 border-b-2 border-border">
              ...
              <TableHead className="text-[11px] font-bold uppercase tracking-wider text-text-muted">Score</TableHead>
            ...
            {paginatedData.length === 0 ? (
              ...
              paginatedData.map((tender) => (
                <TableRow key={tender.id} className="hover:bg-[#faf8f6]">
                  ...
                  <TableCell className="text-text-primary font-semibold">{tender.score}</TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="bg-surface border-border w-[180px]">
                        ...
                        <DropdownMenuItem className="text-text-primary focus:bg-bg focus:text-text-primary">Download</DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
                  </TableCell>
                </TableRow>
