...
const mockData = [
  { id: 'T-1009', title: 'Software Development Services', category: 'IT & Technology', type: 'ICB', date: '2026-02-15', reason: 'Procurement requirements changed' },
  { id: 'T-1010', title: 'Office Furniture Supply', category: 'Goods', type: 'NCB', date: '2026-02-12', reason: 'Budget reallocation' },
];
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-surface-2 border-b-2 border-border">
              ...
              <TableHead className="text-[11px] font-bold uppercase tracking-wider text-text-muted">Cancelled Date</TableHead>
                ...
                <TableRow key={tender.id} className="hover:bg-[#faf8f6]">
                  ...
                  <TableCell>
                    <div className="max-w-[300px]">
                      <Badge className="bg-[#f0ede8] text-text-muted px-2.5 py-1 font-semibold text-[12px] rounded-full mb-1">
                        Cancelled
                      </Badge>
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="bg-surface border-border w-[180px]">
                        ...
                        <DropdownMenuItem className="text-text-primary focus:bg-bg focus:text-text-primary">Archive</DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
                  </TableCell>
                </TableRow>
