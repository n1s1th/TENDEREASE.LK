...
export default function RegistrationPage() {
  const registrations = useOfficerDashboardStore((s) => s.registrations);
  const registrationsLoading = useOfficerDashboardStore((s) => s.registrationsLoading);
  const fetchRegistrations = useOfficerDashboardStore((s) => s.fetchRegistrations);
  const acceptRegistration = useOfficerDashboardStore((s) => s.acceptRegistration);
  const deleteRegistration = useOfficerDashboardStore((s) => s.deleteRegistration);
